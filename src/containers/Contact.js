  ...
  render() {
    return (
      <div>
        ...
        <FormDiv>
          <form action="https://formspree.io/info@rachnaradio.com" method="POST" id="contactform">
            <div>
        ...
        <EmailMe>Or just email me directly at <a href="mailto:info@rachnaradio.com" target="_blank"><strong>info@rachnaradio.com</strong></a>.</EmailMe>
